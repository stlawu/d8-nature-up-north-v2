...
nun_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of nun_radix theme and run the following commands:
`nvm use`
...
`drush en nun_radix -y`
`drush config-set system.theme default nun_radix -y`
