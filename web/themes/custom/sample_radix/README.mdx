...
sample_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of sample_radix theme and run the following commands:
`nvm use`
...
`drush en sample_radix -y`
`drush config-set system.theme default sample_radix -y`
